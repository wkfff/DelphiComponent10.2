...
type
  TKeyPropertiesForm = class(TForm)
    OKBtn: TButton;
    CancelBtn: TButton;
...
//-----------------------------------------------------------------------------
constructor TKeyPropertiesForm.Create(AOwner: TComponent; Key: TKey);
begin
...
//-----------------------------------------------------------------------------
procedure TKeyPropertiesForm.UpdateControls;
begin
...
//-----------------------------------------------------------------------------
procedure TKeyPropertiesForm.KeyTypeRadioGroupClick(Sender: TObject);
begin
  UpdateControls;
...
//-----------------------------------------------------------------------------
procedure TKeyPropertiesForm.FormClose(Sender: TObject;
...
//-----------------------------------------------------------------------------
procedure TKeyPropertiesForm.SaveProperties;
begin
  // set type
...
//-----------------------------------------------------------------------------
procedure TKeyPropertiesForm.LoadProperties;
begin
  m_Load := True;
...
//-----------------------------------------------------------------------------
procedure TKeyPropertiesForm.FontBtnClick(Sender: TObject);
begin
