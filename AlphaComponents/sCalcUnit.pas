...
uses sCurrEdit, sCustomComboEdit, acntUtils, sSkinManager, sGraphUtils, sMessages, sVCLUtils, sSkinProps, sGlyphUtils;
  ...
  case Message.Msg of
    SM_ALPHACMD:
      case Message.WParamHi of
        AC_GETBG:
          if FEditor <> nil then begin
            if TsCustomNumEdit(FEditor).SkinData.SkinManager <> nil then begin
