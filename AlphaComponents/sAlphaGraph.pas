...
procedure WriteColorW(const Bmp: TBitmap; Text: WideString; Enabled: boolean; lRect: TRect; Flags: Cardinal; Color: TColor);
procedure WriteText32(const Bmp: TBitmap; Text: PacChar; Enabled: boolean; var aRect: TRect; Flags: Cardinal; SkinIndex: integer; State: integer; SkinManager: TObject = nil; IsAnsi: boolean = False);
    ...
    if Assigned(SkinManager) then
      with TsSkinManager(SkinManager) do begin
        ...
        if IsValidSkinIndex(SkinIndex) then
          with gd[SkinIndex].Props[State], R do begin
