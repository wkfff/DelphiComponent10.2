...
{$IFNDEF NOTFORHELP}
  ...
  TsColorBoxStyles = (cbStandardColors, cbExtendedColors, cbSystemColors, cbIncludeNone, cbIncludeDefault, cbCustomColor, cbPrettyNames, cbCustomColors, cbSkinColors);
  ...
  with SkinData.SkinManager.ConstData.ComboBtn do begin
    ...
    if FCommonData.SkinManager.IsValidImgIndex(GlyphIndex) then
      DrawSkinGlyph(FCommonData.FCacheBmp,
                    Point(R.Left + (WidthOf(R) - FCommonData.SkinManager.ma[GlyphIndex].Width) div 2,
                    (Height - FCommonData.SkinManager.ma[GlyphIndex].Height) div 2), Mode, 1, FCommonData.SkinManager.ma[GlyphIndex],
