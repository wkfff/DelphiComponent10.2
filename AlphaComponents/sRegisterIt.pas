...
begin
  ...
  try
    SplashScreenServices.AddPluginBitmap('AlphaControls 2018', Bmp.Handle, False,
{$IFNDEF ALITE}
...
{$ELSE}
  RegisterComponents(s_AlphaLite, [
    ...
    TsLabel, TsWebLabel, TsLabelFX, TsComboBox, TsListBox, TsCheckListBox, TsGauge, TsAlphaImageList, TsTitleBar, TsFontStore]);
