...
constructor TacPickListExItem.Create(Collection: TCollection);
begin
  inherited
end;
...
function TacPickListEx.ValueByName(aName: String): String;
begin
end;
...
//    if Button.Visible then
//      Button.PaintTo(SkinData.FCacheBMP.Canvas.Handle, Point(Button.Left + BtnOffset(Self), Button.Top + BtnOffset(Self)));
...
//        if (not Focused{ControlIsActive(SkinData)} or (SkinData.PrintDC = NewDC)) and Button.Visible then
//          Button.PaintTo(NewDC, Point(Button.Left + BtnOffset(Self), Button.Top + BtnOffset(Self)));
...
//          if ShowButton then
//            Button.PaintTo(DC, Point(Button.Left + BtnOffset(Self), Button.Top + BtnOffset(Self)));
...
//    if ControlIsActive(SkinData) and Button.Visible then
//      Button.PaintTo(NewDC, Point(Button.Left + BtnOffset(Self), Button.Top + BtnOffset(Self)));
...
begin
  if Dest is TacEditButtonItem then begin
    Dest.Assign(Self);
{    FButton.Assign(TacEditButtonItem(Source).Button);
    GetGlyphMode.ImageIndex := TacEditButtonItem(Source).GetGlyphMode.ImageIndex;
    GetGlyphMode.ImageIndexHot := TacEditButtonItem(Source).GetGlyphMode.ImageIndexHot;
...
function TacEditButtonEx.GlyphWidth: integer;
begin
