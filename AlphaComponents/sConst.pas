...
const
  CompatibleSkinVersion = 8.45; // Minimal version of supported skins the in current version of the package
  MaxCompSkinVersion = 13.99;
...
{$ENDIF}
  ...
  TacAnimTypeCtrl = (atcFade, atcAero, atcBlur, atcBlur2);
...
{$ENDIF}
  ...
  acArrowSize:           integer = ac_BaseArrowWidth - 2;
...
{$IFNDEF NOTFORHELP}
  ...
  ac_CYCAPTION:    integer = -1;
  ac_CYSMCAPTION:  integer = 0;

  ac_ArrowWidth:  integer = ac_BaseArrowWidth;
